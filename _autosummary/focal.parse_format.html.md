...
| [`parse`](#focal.parse_format.parse)(format, string[, extra_types, ...])   | Using "format" attempt to pull values from "string".                             |
|----------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|
| [`search`](#focal.parse_format.search)(format, string[, pos, endpos, ...])  | Search "string" for the first occurrence of "format".                            |
| [`findall`](#focal.parse_format.findall)(format, string[, pos, endpos, ...]) | Search "string" for all occurrences of "format".                                 |
| [`with_pattern`](#focal.parse_format.with_pattern)(pattern[, regex_group_count])  | Attach a regular expression pattern matcher to a custom type converter function. |
